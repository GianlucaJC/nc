...
$nc_mt="0";
if (isset($_GET['nc_mt'])) $nc_mt=$_GET['nc_mt'];
...
<head>
  ...
  <title>Non Conformità | Login</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><b>Non Conformità</b> Liofilchem</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
	  ...
	  <input type='hidden' name='nc' id='nc' value='<?php echo $nc;?>'>
	  <input type='hidden' name='nc_mt' id='nc_mt' value='<?php echo $nc_mt;?>'>
	...
	$.ajax({
		...
		success: function (data){
			...
			if (record.header.login=="OK") {
				url="../../index.php";
				if (nc!="0") url="../elenconc/lista.php?nc="+nc;
				if (nc_mt!="0") url="../elenconc/lista_mt.php?nc_mt="+nc_mt;
				location.href=url;
			} else {
