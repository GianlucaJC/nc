...
include_once '../../MVC/Controllers/C_tipologie_pr.php';
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tipologie NC di Prodotto</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">Pages</li>
			  <li class="breadcrumb-item active">Tipologie NC PR</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
		...
		<div class="row">  
          ...
          <div class="col-lg-12">
			<form action="tipologie_nc_pr.php" method="post" id='frm_view' name='frm_view' autocomplete="off" >  
				  ...
				  <div class="card-body">
					...
					<div id='div_new' class='mt-4' style='<?php echo $view_new;?>'>
						...
						<div class='mt-4'>
							...
							<?php
								if ($edit==0) echo "Crea Tipologia di prodotto";
								else echo "Modifica Tipologia di prodotto";
							?>
							</button>
							<button onclick="location.href='tipologie_nc_pr.php'" type='button' id='btn_close' class='btn btn-secondary'>Chiudi</button>
						</div>
					...
					<table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								!-->
								<th>Elimina</th>
								<th>Descrizione Tipologia di prodotto</th>
							</tr>
						</thead>
					  <tbody>
						<?php
							...
							for ($sca=0;$sca<=count($elenco_tipologie)-1;$sca++) {
									...
									echo "<tr>";
										echo "<td style='text-align:center;'>";
											echo "<a href='tipologie_nc_pr.php?id_tipo=$id_t'>";
...
<script>
  $(function () {
			$("#example1").DataTable({
				...
				"language": {
					"lengthMenu": "Mostra _MENU_ Tipologie di prodotto per pagina &nbsp&nbsp",
					"zeroRecords": "Non ci sono Tipologie di prodotto",
					"info": "Pagina mostrata _PAGE_ di _PAGES_ di _TOTAL_ Tipologie di prodotto",
					"infoEmpty": "Non risultano Tipologie di prodotto",
	...
	$(".btn_remove").bind('click', function(event) {
		if (!confirm("Sicuri di rimuovere la tipologia di prodotto?")) return false;
