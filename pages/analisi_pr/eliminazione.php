			...
			<div id='div_seconda_sezione' class='mt-3 container'  style='<?php echo $disp; ?>'>
					...
					<div class='row mt-2'>
						...
						<div class="col-md-2">
							<div class="form-floating mb-3 mb-md-0">
								<input class="form-control" id="data_eliminazione_mv" name='data_eliminazione_mv' type="date" value="<?php echo $info_nc_pr[0]['data_eliminazione_mv'];?>"  required  <?php echo $dis3; ?> />
				...
				<form action="<?php echo $action; ?>" method="post" id='frm_ris' name='frm_ris' autocomplete="off" class="needs-validation2" novalidate >
					<div class='row mt-2'>
						...
						<div class="col-md-2">
							<div class="form-floating mb-3 mb-md-0">
								<input class="form-control" id="data_eliminazione_mf" name='data_eliminazione_mf' type="date" value="<?php echo $info_nc_pr[0]['data_eliminazione_mf'];?>" required  <?php echo $dis4; ?> />
				...
				<form action="<?php echo $action; ?>" method="post" id='frm_ris' name='frm_ris' autocomplete="off" class="needs-validation2" novalidate >
					<div class='row mt-2'>
						...
						<div class="col-md-2">
							<div class="form-floating mb-3 mb-md-0">
								<input class="form-control" id="data_eliminazione_na" name='data_eliminazione_na' type="date" value="<?php echo $info_nc_pr[0]['data_eliminazione_na'];?>" required  <?php echo $dis5; ?> />
