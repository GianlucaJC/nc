...
include_once '../../MVC/Controllers/C_analisi_pr.php';
    ...
    <div class="content">
      <div class="container-fluid">
			...
			<nav class="bg-dark navbar-dark">
			  ...
			  <div class="container">
				<center>
				<a href="javascript:void(0)" class="navbar-brand"><i class="fas fa-calendar-check"></i>  Analisi/Valutazione - Risoluzione NC di Prodotto</a>
				</center>
			  </div>
			 </nav>
...
?>			
			...
			<div class="accordion mt-3" id="myAccordion">
				<?php
					...
					if ($info_nc_pr[0]['firma_valutazione1']!=0 && $info_nc_pr[0]['firma_valutazione2']!=0) $stile_agg="background-color:green;color:white";
				...
				<div class="accordion-item">
					...
					<!-- Form   V A L U T A Z I O N E !-->
						...
						<form action="<?php echo $action;?>" method="post" id='frm_val' name='frm_val' autocomplete="off" class="needs-validation1" novalidate >
							<input type='hidden' name='accordion1' id='accordion1'>
							<input type='hidden' name='id_ref' id='id_ref' value='<?php echo $id_ref;?>'>
							<input type='hidden' id='check_sign_valutazione1' value="<?php echo $info_nc_pr[0]['firma_valutazione1'];?>">
							<input type='hidden' id='check_sign_valutazione2' value="<?php echo $info_nc_pr[0]['firma_valutazione2'];?>">
							
							
							<input type='hidden' name='submit_sign_valutazione' id='submit_sign_valutazione'>
							<input type='hidden' id='id_ref' name='id_ref' value='<?php echo $id_ref; ?>'>
				...
				<?php
					...
					*/
					$stile_agg="background-color:#ffdf7e;color:red";
					if ($info_nc_pr[0]['sign_ris1']!=0 && $info_nc_pr[0]['sign_ris2']!=0) $stile_agg="background-color:green;color:white";
					if ($stato==0 || $stato==1) $stile_agg="background-color:red;color:white";
					if ($stato==1) $stile_agg="background-color:orange;color:white";
				...
				<?php
					...
					*/
					$stile_agg="background-color:#ffdf7e;color:red";
					if (($info_nc_pr[0]['sign_eliminazione_mf']!=0 && $info_nc_pr[0]['sign_eliminazione_mv']!=0) || $info_nc_pr[0]['sign_eliminazione_na']!=0 ) $stile_agg="background-color:green;color:white";
					if ($stato==0 || $stato==1) $stile_agg="background-color:red;color:white";
					if ($stato==1) $stile_agg="background-color:orange;color:white";
				...
				<?php
					...
					*/
					$stile_agg="background-color:#ffdf7e;color:red";
					if ($info_nc_pr[0]['sign_chiusura_nc']!=0) $stile_agg="background-color:green;color:white";
