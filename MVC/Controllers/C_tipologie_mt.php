<?php
	...
	if (isset($_POST['btn_new'])) {
		...
		if (isset($_POST['id_edit'])) {
			...
			$ins_new=$main_tabelle->new_tipo_nc(2,$id_edit);
			$id_edit=0;
		}	
		else	
			$ins_new=$main_tabelle->new_tipo_nc(2,0);
		
	}	
	
	$edit_tipo="";
	if (isset($_GET['id_tipo'])) $edit_tipo=$main_all->tipo_nc(2,$_GET['id_tipo']);
	$edit=0;
	if (is_array($edit_tipo)) $edit=1;
	

	$elenco_tipologie=$main_all->tipo_nc(2);
