<?php
		...
		$mail->FromName = "Liofilchem NC-MT";
		...
		$msg.="<a href='http://liojls01.ad.liofilchem.net/nc/index.php?nc_mt=$ref'>";
			$msg.="clicca quì";
		$msg.="</a><br>";
		...
		$mail->Subject = "Nuova segnalazione NC di Materiale";
		$mail->Body = $msg;
		$mail->AltBody = "Nuova segnalazione NC di materiale";
